...
<html lang="pt-br">
    ...
    <head>
        <meta charset="UTF-8">
        <title>FakeBook | Linha do Tempo</title>
    ...
    <body>
        ...
        <div id = "container-opcoes">              
            <div id = "itens-opcoes">
                <h3><a href="../perfil/index.php">Perfil</a></h3>
        ...
        <div>
            <form method="post">
                ...
                <input type="text" name="postagem" class = "campo" maxlength="1000" spellcheck="true">
        ...
        //Caso o botão postar seja apertado o sistema ira armazenar a postagem
            ...
            if (isset($_POST['postagem'])){
                ...
                $u->conectar();
                if($u->msgError == ""){
                    if($u->postar($id_user, $postagem, $data)){
            ...
            */
        ?>
        <div id="LinhaTempoTextoContainer">
        ...
        <?php
            ...
            $u->conectar();
            $retornoP = $u->retornarPostagemSeguido($id_user);
            ...
            while($exibirPostagem = $retornoP->fetch()){
                ...
                if($retornoC->rowCount() > 0){
                    while($exibirComentario = $retornoC->fetch()){
                        ...
                        $id_quem_comentou = $exibirComentario['1'];
                        $nomeC = $u->apelidoUsuario($id_quem_comentou);
                        ...
                        if(!($u->verificarBloqueado($id_user, $id_quem_comentou))){

                            ?><div id="container-comentario"><?php
                            
                                if($id_user == $id_quem_comentou){
                                    ?>
                                    <form method="post"> 
                                        <div id="deletarBtn">
                                            <?php //Botão de deletar comentário?>
                                            <input type="hidden" name = "id_deletar_comentario" value= "<?php echo $id_comentario; ?>" >
                                            <input class="InputDeletar" type="submit" name = "deletarComentario" value = "Deletar" class="btn">
                                        </div>    
                                    </form>
                                    <?php
                                }
                                ...
                                ?><h3><?php print("$nomeC");?> <span> <?php print("$partes_dataC[2]/$partes_dataC[1]/$partes_dataC[0] <br>");?> </span></h3><?php 
                                ?><p> <?php print("$textoC"); ?> </p><?php 
